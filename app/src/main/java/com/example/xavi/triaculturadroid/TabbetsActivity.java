...
public class TabbetsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabs.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                mViewPager.setCurrentItem(tabs.getCurrentTab());
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tabbets, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_tabbets, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm, List<FragmentPagerItem> items ) {
            super(fm);
            this.items = items;
        }
        @Override
        public Fragment getItem(int position) {
            FragmentPagerItem fpi = getIt(position);
            if( fpi == null )
                return null;
            else
                return fpi.getFragment();
        }
        ...
        @Nullable
        private FragmentPagerItem getIt(int position) {
            if( items == null )
                return null;
            else {
